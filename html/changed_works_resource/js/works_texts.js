...
hrc_slider_detail_3_value = 
  '플레이스에이의 Human Recognition '+
  'Soultion AI Engine은 <br>3천만 장 이상의 ' +
  '데이터로 학습되어 별도의 <br>부착물이나 ' +
  '특수한 환경 구축 없이<br> 고품질 '+
  '모션 데이터를 얻을 수<br> 있습니다. ' +
  '4-8대의 일반적인 RGB <br>카메라만으로 '+
  '기존 스튜디오 촬영에 <br>버금가는 ' +
  '정밀한 3D 모션 캡처 <br>서비스를 제공합니다.'
hac_slider_detail_1_value = 
  '추출한 신체 모션 데이터를 3D 캐릭터의 '+
  '움직임으로 쉽게 변환할 수 있습니다. ' +
  '이미지를 바탕으로 아바타를 생성하거나 '+
  '원하는 캐릭터를 불러와 모션 데이터와 '+
  '결합합니다. 플레이스에이의 avatar retargeting' +
  '기술로 서로 다른 비율과 체형의 ' +
  '캐릭터들을 동일한 동작으로 자연스럽고 '+
  '매끄럽게 표현해보세요.'
hac_slider_detail_2_value = 
  '영상 속 사람의 미세한 표정까지 '+
  '인식하여 3D 캐릭터의 표정으로 ' +
  '전환합니다. AI 기술을 통해 실시간으로 '+
  '표현하는 캐릭터의 표정은 ' +
  '가상 환경에서도 실감 나는 '+
  '커뮤니케이션을 가능하게 합니다.';
...
hrc_slider_detail_3_value = 
  '플레이스에이의 Human Recognition '+
  'Soultion AI Engine은 3천만 장 이상의 ' +
  '데이터로 학습되어 별도의 부착물이나 ' +
  '특수한 환경 구축 없이 고품질 '+
  '모션 데이터를 얻을 수 있습니다. ' +
  '4-8대의 일반적인 RGB 카메라만으로 '+
  '기존 스튜디오 촬영에 버금가는 ' +
