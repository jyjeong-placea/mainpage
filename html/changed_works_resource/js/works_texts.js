...
sub_header_value = 
  '<p class="placea_intro_text">플레이스에이는</p>' +
  '<p>세상에 존재하는 많은 것들을 컴퓨터가 이해하고</p>' +
  '<p>처리할 수 있도록 데이터로 가공해 냅니다.</p>';

intro_video_contents_text_value = 
'현실을 이루고 살아가는 사람들과 다양한 환경을 가상 공간에 <br> ' +
'투영하여 꿈꿔왔던 다양한 시도를 가능하게 합니다. <br> ' +
'<br> ' +
'플레이스에이의 인공지능 기술은 어디에서나, 정확하고, <br> '+
'빠르게 그 과정을 실행할 수 있도록 돕습니다.<br>';
...
hrc_bottom_title_1_value = '한 대의 <br> 카메라(로)도 충분합니다'
hrc_bottom_title_2_value = '실시간으로 <br> 영상을 처리합니다'
hrc_bottom_title_3_value = '편리하게 서비스에 <br> 적용할 수 있습니다'
hac_bottom_title_4_value = '플러그인을 통해 바로 적용해보세요'
hac_bottom_title_5_value = '나를 실감나게 따라하는 또다른 나'
orc_bottom_title_6_value = '역동적인 가상 환경을 구축합니다'
orc_bottom_title_7_value = '보이는 모습 그대로 옮겨줍니다'
...
hrc_bottom_sub_1_value =
  '스마트폰 카메라 한 대로 촬영된 영상이면 <br>' +
  '누구나 손쉽게 3D 모션데이터를 <br>' +
  '얻을 수 있습니다. <br>' +
  '<br>'+
  '고비용의 장치를 필요로 하지 않기 때문에 <br>'+
  '모션 인식 기술을 활용한 <br>'+
  '다양한 서비스로 응용할 수 있습니다. <br>';

hrc_bottom_sub_2_value = 
  'HRS는 70fps의 빠른 속도로 3D 위치 <br>' +
  '및 자세를 인식하여 실시간 서비스를 <br>' +
  '가능하게 합니다. <br>' +
  '<br>' +
  '배경과 지면을 함께 인식하고 환경을 함께 <br>' +
  '분석하는 플레이스에이의 독보적인 기술력으로 <br>' +
  '별도의 후처리없이 실시간으로 정확하고 <br>' +
  '자연스럽게 움직임이 표현됩니다. <br>' ;

hrc_bottom_sub_3_value = 
  '영상만 있다면 모션캡쳐를 위해 스튜디오를 <br>' + 
  '대여하지 않아도, 배우를 섭외할 <br> ' +
  '필요가 없습니다. <br>' +
  '<br>' +
  '현실에선 재현 불가능한 애니메이션 속 <br>' +
  '캐릭터의 움직임 역시 얻을 수 있습니다. <br>';

hac_bottom_sub_4_value = 
  '다양한 프로그램에서 사용가능한 fbx 출력파일을 제공 합니다. <br>' + 
  'Unity, Unreal 등과 같은 게임엔진은 물론 <br>' +
  'Maya, Max와 같은 렌더링 엔진에서 사용가능합니다. <br>' +
  '사용하고 계신 프로그램에 지금 바로 적용해보세요. <br>' +
  '(캐릭터를 불러오고 등등 플러그인을 사용하는 프로세스와 <br>' +
  '편익 중심으로 워딩 추가)' ;

hac_bottom_sub_5_value = 
  '얼굴 표정의 변화와 신체의 움직임이 설정한 3D 캐릭터에 실시간으로 <br>' +
  '반영되어 내가 원하는 모습 그대로 실감나게 표현됩니다. 변환되는 <br>' +
  '캐릭터의 체형에 따라 움직임뿐만 아니라 걸음걸이, 속도까지 자동으로 <br>' +
  '보정하여 후보정 없이도 즉각적인 인터랙션이 가능합니다. <br>';

orc_bottom_sub_6_value = 
  '신체의 움직임 이외에도 주변 사물과 환경을 이루는 다양한 물체의 <br>' +
  '움직임을 추적할 수 있습니다. 보다 넓은 시야에서 다양한 움직임이 <br>' +
  '이루어지는 공간에 대한 정보를 처리함으로써 더욱 역동적인 <br>' +
  '가상 환경을 구축할 수 있습니다.'

orc_bottom_sub_7_value =
  '플레이스에이의 다양한 실시간 인식 기술은 이미지 속 아이템의 형태, <br>'+
  '색상, 패턴, 질감 등을 종합적으로 분석하여 디지털 아이템으로 <br> ' +
  '복제하는 기술과 결합하여 궁극적인 가상 세계를 완성합니다.<br> ' +
  '한번의 촬영으로 현실에 존재하는 수많은 것들을 디지털 공간으로 <br>' +
  '옮길 수 있습니다.'
}
